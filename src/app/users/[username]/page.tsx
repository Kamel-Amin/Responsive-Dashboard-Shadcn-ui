    ...
    <div>
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Kamel Amin</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
        ...
        <div className='w-full xl:w-2/3 space-y-6'>
          ...
          <div className='bg-primary-foreground p-4 rounded-lg space-y-2'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='text-xl font-semibold'>Kamel Amin</h1>
            </div>
            <p className='text-sm text-muted-foreground'>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nesciunt
              earum quos optio tempore id placeat, ullam, nemo veniam molestias
              dignissimos ipsa debitis pariatur officiis tenetur.
            </p>
          </div>
          {/* CHART CONTAINER */}
